			...
			try {
				...
				while(client.bytesAvailable > 0)
				{
					...
					switch (messageType)
					{
						...
						case Client.MESSAGE_SAVE_IN_SERVER:
							var clientID:String = client.readUTF();
							var dataToSave:* = client.readObject();
							break;
						
						case Client.MESSAGE_LOAD_FROM_SERVER:
							var clientDataStoraged:* = allDataStoredFromClients[client.readUTF()];
							client.writeUTF(Client.MESSAGE_LOAD_FROM_SERVER);
							client.writeObject( clientDataStoraged );
							client.flush();
							break;
					}
				}
